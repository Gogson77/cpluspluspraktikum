...
public:
	...
	int fUpisi() {
		cout << "Upisite" << endl;
		cout << "naziv filma: "; cin >> pNaziv;
		cout << "ime rezisera: "; cin >> pReziser.pIme;
		cout << "prezime rezisera: "; cin >> pReziser.pPrezime;
		cout << "broj gledalaca: "; cin >> pBrGled;
		cout << "cijena karte: "; cin >> pCijenaKarte;
		return 0;
	};
...
public:
	...
	int fUpisi() {
		...
		cout << "broj gledalaca: "; cin >> pBrGled;
		cout << "cijena karte: "; cin >> pCijenaKarte;
		cout << "troskovi filma: "; cin >> pRashodi;
		cout << "porezna stopa: "; cin >> pPoreznaStopa;
		cout << endl;
		return 0;
	};
